...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: "https://jamesjager.devcamp.space/portfolio/portfolio_items",
            apiAction: 'post'
        };
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://jamesjager.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
    ...
    handleSubmit(event) {
        axios({
            ...
            .then(response => {
                ...
                console.log("portfolio form handSubmit error", error);
            })
